export const THEMES = [
  { id: 'light', label: 'Light', color: 'linear-gradient(165deg, #ffffff 0%, #f8fafc 100%)' },
  { id: 'dark', label: 'Dark', color: 'linear-gradient(180deg, #18181b 0%, #09090b 100%)' },
  { id: 'linear', label: 'Linear', color: 'linear-gradient(180deg, #111111 0%, #000000 100%)' },
  { id: 'glass', label: 'Glass', color: 'linear-gradient(160deg, #eef2f6 0%, #e0e7ff 40%, #fce7f3 100%)' },
